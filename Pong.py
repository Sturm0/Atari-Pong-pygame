...
ventana = pygame.display.set_mode(resolución,flags=pygame.FULLSCREEN|pygame.HWSURFACE|pygame.DOUBLEBUF|pygame.SCALED) #Configuración de ventana, SCALED solo sirve para pygame 2 o superior desactivar si se esta usando una versión anterior. FULLSCREEN según pruebas da problemas en ciertos casos, leer README para más información
puntJugador1 = 0
puntJugador2 = 0
